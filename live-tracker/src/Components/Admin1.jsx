...
import TravelDistanceHistory from "./TravelDistanceHistory";
...
const Admin1 = () => {
    ...
    const renderContent = () => {
        ...
        switch (activeTab) {
            ...
            case "Travel Distance History":
                return <TravelDistanceHistory token={token} />;
                    ...
                    <div className={styles.content}>
                        ...
                        >
                            <nav className="space-y-4">
                                {["Dashboard", "Manage Employees", "Employee Locations", "Employee Attendance","Travel Distance History", "Admin Profile", "Logout"]
                                    ...
                                    .map((tab) => (
                                        ...
                                        >
                                            ...
                                            {tab === "Travel Distance History" && <Folder size={18} />} {/* 👈 icon */}
